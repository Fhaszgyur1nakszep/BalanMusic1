...
module.exports = {
    ...
    execute(client, message) {
        ...
        embed.setDescription(`Kötet **${queue.volume}**%\nIdőtartam **${trackDuration}**\nLoop mód **${methods[queue.repeatMode]}**\nKérelme ${track.requestedBy}`);
        ...
        saveButton.setLabel('Mentse el ezt a számot');
        saveButton.setCustomId('saveTrack');
        saveButton.setStyle('SIKER');
